                    ...
                    switch (arr.child) {
                        u8 => {
                            ...
                            if (arr.sentinel) |sentinel| {
                                ...
                                ret[size] = @as(*u8, @ptrCast(@constCast(sentinel))).*;
            ...
            switch (@typeInfo(SliceType)) {
                .pointer => |ptr_info| {
                    if (ptr_info.sentinel) |sentinel| {
                        ...
                        slice[data.len] = @as(*u8, @ptrCast(@constCast(sentinel))).*;

                        return slice[0..data.len :@as(*u8, @ptrCast(@constCast(sentinel))).*];
                    } else {
            ...
            Text, Blob => {
                ...
                switch (type_info) {
                    ...
                    .array => |arr| if (arr.sentinel) |sentinel| {
                        const res = mem.sliceTo(&name.?, @as(*u8, @ptrCast(@constCast(sentinel))).*);
